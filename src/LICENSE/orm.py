...
class BaseModel(dict, metaclass=ModeMetaclass):
    ...
    def __getattr__(self, item):
        try:
            ...
            raise AttributeError(r"'BaseModel' object has no attribute '%s'" % item)
    ...
    def getValueOrDefault(self, key):
        ...
        if value is None:
            ...
            if field.default is not None:
                value = field.default() if callable(field.default) else field.defualt
